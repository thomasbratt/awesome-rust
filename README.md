...
* [thomasbratt/watchmaker](https://github.com/thomasbratt/watchmaker/blob/main/core/README.md) — Genetic Algorithm library. Implement a single trait for your problem and call a single method. Supports progress reporting, configurable parameters.  [![CircleCI](https://circleci.com/gh/thomasbratt/watchmaker/tree/main.svg?style=svg)](https://circleci.com/gh/thomasbratt/watchmaker/tree/main)
* [thomasbratt/watchmaker_vm](https://github.com/thomasbratt/watchmaker_vm/blob/main/core/README.md) — Virtual Machine for use with Genetic Algorithms. Any random sequence of bytes is a valid program.  Simple orthogonal instruction format. Each instruction is a 64 bit value, including operands..  [![CircleCI](https://circleci.com/gh/thomasbratt/watchmaker_vm/tree/main.svg?style=svg)](https://circleci.com/gh/thomasbratt/watchmaker_vm/tree/main)
...
* [michoo/spasm](https://github.com/michoo/spasm) — SPASM Smol PASsword Manager to use in your terminal, very simple to modify. With argon2, password generators(random, Dice,..), Check password complexity (Shannon), Check password on HIBP (Have I Been Pwnd),...
...
* Ion
  * [Couragium/ion-binary-rs](https://crates.io/crates/ion-binary-rs) — Amazon's Ion binary format encoder, decoder and hasher [<img src="https://github.com/Couragium/ion-binary-rs/workflows/Rust/badge.svg">](https://github.com/Couragium/ion-binary-rs/actions)
* JSON
...
* XML
  * [tafia/quick-xml](https://github.com/tafia/quick-xml) — High performance XML pull reader/writer <img src="https://github.com/tafia/quick-xml/actions/workflows/rust.yml/badge.svg">
